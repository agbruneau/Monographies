...
4. **Exécuter le contrôle de migration du §7, point 4.** Il est le seul qui puisse établir qu'un élément retiré d'un rapport n'a pas été recopié dans une pièce. Aucune passe ne l'a conduit à ce jour.
